...
func newDistro(isCentos bool) distro.Distro {
	...
	edgeOCIImgTypeX86_64 := ImageTypeS2{
		...
		packageSets: map[string][]string{
			"commit":    edgeImgTypeX86_64.packages,
			"container": edgeContainerPkgs,
		},
		excludedPackageSets: map[string][]string{"commit": edgeImgTypeX86_64.excludedPackages},
	...
	edgeInstImgTypeX86_64 := ImageTypeS2{
		...
		packageSets:         map[string][]string{"commit": edgeImgTypeX86_64.packages, "build": edgeBuildPkgs, "installer": edgeInstallerPkgs},
		excludedPackageSets: map[string][]string{"commit": edgeImgTypeX86_64.excludedPackages},
		enabledServices:     edgeImgTypeX86_64.enabledServices,
		rpmOstree:           true,
		bootISO:             true,
	...
	edgeOCIImgTypeAarch64 := ImageTypeS2{
		...
		filename:            "rhel84-container.tar",
		mimeType:            "application/x-tar",
		packageSets:         map[string][]string{"commit": edgeImgTypeAarch64.packages, "container": edgeContainerPkgs},
		excludedPackageSets: map[string][]string{"commit": edgeImgTypeAarch64.excludedPackages},

...
func TestFileCustomizationToFsNodeFile(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", nil, common.ToPtr(os.FileMode(0700)), nil, nil)),
		},
		{
			Name: "path-and-mode-invalid",
			File: FileCustomization{
		...
		},
		{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", nil, nil, "root", "root")),
		},
		{
			Name: "path-user-group-int64",
			File: FileCustomization{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", nil, nil, int64(0), int64(0))),
		},
		{
			Name: "path-and-user-invalid-string",
			File: FileCustomization{
		...
		},
		{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", nil, nil, nil, "root")),
		},
		{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", nil, nil, nil, int64(0))),
		},
		{
			Name: "path-and-group-invalid-string",
			File: FileCustomization{
		...
		},
		{
			...
			Want: ensureFileCreation(fsnode.NewFile("/etc/file", []byte("hello world"), nil, nil, nil)),
		},
	}
...
func TestFileCustomizationsToFsNodeFiles(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Want: []*fsnode.File{
				ensureFileCreation(fsnode.NewFile("/etc/file", []byte("hello world"), nil, "root", "root")),
				ensureFileCreation(fsnode.NewFile("/etc/file2", []byte("hello world"), nil, int64(0), int64(0))),
			},
		},
		{

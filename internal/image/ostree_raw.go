...
func rawImagePipelines(img *OSTreeRawImage, m *manifest.Manifest, buildPipeline *manifest.Build) *manifest.XZ {
...
func (img *OSTreeRawImage) InstantiateManifest(m *manifest.Manifest,
	...
	xzPipeline := rawImagePipelines(img, m, buildPipeline)

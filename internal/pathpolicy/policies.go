...
// TODO: determine the actual list of directories that should not be allowed to be modified
...
// TODO: determine the actual list of files should not be allowed to be modified
